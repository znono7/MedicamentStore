...
{
     public class EntreeTransactionDocument : IDocument
    {
        public List<EnterTransaction> Transactions { get; }

        public EntreeTransactionDocument(List<EnterTransaction> transactions)
        {
        ...
        private void ComposeTable(IContainer container)
        {
            ...
            container.Table(table =>
            {
                ...
                foreach (var item in Transactions)
                {
                    ...
                    table.Cell().Element(CellStyle).AlignCenter().Text($"+ {item.QuantiteTransaction}");
