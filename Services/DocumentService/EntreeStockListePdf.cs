...
{
    public class EntreeStockDocument : IDocument
    {
        public EntreeStockDocument(ObservableCollection<TransactionDto> transactions)
        {
        ...
        private void ComposeHeader(IContainer container)
        {
            ...
            container.Row(row =>
            {
                row.RelativeItem().Column(column =>
                {
                    ...
                    column.Item().AlignCenter().Text("Liste des Entrées de Stock de Produits Pharmaceutiques").Style(titleStyle);
